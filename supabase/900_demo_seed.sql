...
--
--  Run after schema.sql and 002–008, in Supabase -> SQL Editor.
...
-- Clients
-- ------------------------------------------------------------
insert into public.clients (id, name, phone, note, created_at) values
  ('11111111-1111-4111-8111-111111111101', 'Maya Khoury',    '+961 71 204 118', 'Prefers neutral colours. Always in a hurry.', now() - interval '94 days'),
  ('11111111-1111-4111-8111-111111111102', 'Lea Chalhoub',   '+961 3 442 907',  'Repeat client, pays on delivery.',            now() - interval '77 days'),
  ('11111111-1111-4111-8111-111111111103', 'Nour Abou Zeid', '+961 76 615 330', null,                                          now() - interval '61 days'),
  ('11111111-1111-4111-8111-111111111104', 'Rita Semaan',    '+961 70 883 214', 'Size 38. Sensitive to wool.',                 now() - interval '44 days'),
  ('11111111-1111-4111-8111-111111111105', 'Yara Fakhoury',  '+961 81 190 655', null,                                          now() - interval '30 days'),
  ('11111111-1111-4111-8111-111111111106', 'Dana Mroueh',    '+961 71 771 042', 'Found through Instagram, first order.',        now() - interval '18 days'),
  ('11111111-1111-4111-8111-111111111107', 'Joelle Rizk',    '+961 3 928 471',  null,                                          now() - interval '9 days'),
  ('11111111-1111-4111-8111-111111111108', 'Sara Haddad',    '+961 78 336 509', 'Asked about payment by instalments.',          now() - interval '4 days');
...
-- ------------------------------------------------------------
insert into public.requests (name, phone, description, specs, budget, status, created_at) values
  ('Carla Nassar', '+961 71 448 902', 'Black leather shoulder bag, structured, not too big', 'Medium, gold hardware', 320, 'pending', now() - interval '2 days'),
  ('Maya Khoury',  '+961 71 204 118', 'Striped cotton shirt for summer',                     'Size S, blue and white', 110, 'pending', now() - interval '6 hours');
