...
const DICT = {
  en: {
    ...
    "clients.address": "Delivery address",
    "clients.addressHint": "You can add this later from their page.",
  ...
  ar: {
    ...
    "clients.address": "عنوان التسليم",
    "clients.addressHint": "يمكنك إضافته لاحقاً من صفحة الزبون.",
